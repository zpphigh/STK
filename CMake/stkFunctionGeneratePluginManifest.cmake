...
function(stkFunctionGeneratePluginManifest QRC_SRCS)
...
")
  ...
  configure_file("${STK_CMAKE_DIR}/MANIFEST.MF.in" "${_manifest_filepath}" @ONLY)
  configure_file("${STK_CMAKE_DIR}/plugin_manifest.qrc.in" "${_manifest_qrc_filepath}" @ONLY)
