...
#!
#! Usage:
#!   stkFunctionGetCompilerVisibilityFlags(RESULT_VAR)
#!
#! Example:
#!
#! \code
#! set(myflags "-Werror")
#! stkFunctionGetCompilerVisibilityFlags(myflags)
#! \endcode
#!
...
function(stkFunctionGetCompilerVisibilityFlags RESULT_VAR)
  ...
  if(use_visibility_flags)
    ...
    stkFunctionCheckCompilerFlags("-fvisibility=hidden" visibility_flags)
    stkFunctionCheckCompilerFlags("-fvisibility-inlines-hidden" visibility_flags)
