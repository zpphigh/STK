...
function(stkFunctionExtractOptionNameAndValue my_opt var_opt_name var_opt_value)
...
#
# Test - Use cmake -DMACRO_TESTING:BOOL=ON -P stkFunctionExtractOptionNameAndValue.cmake
#
if(MACRO_TESTING)

  message("Testing stkFunctionExtractOptionNameAndValue ...")
  #
  # Test1
  #
  set(test1 "john:ON")
  stkFunctionExtractOptionNameAndValue(${test1} test1_name test1_value)
  ...
  stkFunctionExtractOptionNameAndValue(${test2} test2_name test2_value)
