...
macro(stkMacroBuildQtPlugin)
  ...
  if(NOT STK_EXPORT_HEADER_TEMPLATE)
    message(FATAL_ERROR "STK_EXPORT_HEADER_TEMPLATE is mandatory")
  endif()
  ...
  # Install the library
  # STK_INSTALL_QTPLUGIN_DIR:STRING can be passed when configuring STK
  # By default, it is the same path as STK_INSTALL_LIB_DIR
  # Plugins are installed in a subdirectory corresponding to their types (e.g. designer, iconengines, imageformats...)
  if (NOT STK_INSTALL_QTPLUGIN_DIR)
    set(STK_INSTALL_QTPLUGIN_DIR "${STK_INSTALL_LIB_DIR}")
  endif()
  install(TARGETS ${lib_name}
    RUNTIME DESTINATION ${STK_INSTALL_QTPLUGIN_DIR}/${MY_PLUGIN_DIR} COMPONENT RuntimePlugins
    LIBRARY DESTINATION ${STK_INSTALL_QTPLUGIN_DIR}/${MY_PLUGIN_DIR} COMPONENT RuntimePlugins
    ARCHIVE DESTINATION ${STK_INSTALL_QTPLUGIN_DIR}/${MY_PLUGIN_DIR} COMPONENT Development
    )
...
macro(stkMacroBuildQtDesignerPlugin)
  stkMacroBuildQtPlugin(
    PLUGIN_DIR designer
    ${ARGN})
endmacro()

macro(stkMacroBuildQtIconEnginesPlugin)
  stkMacroBuildQtPlugin(
    PLUGIN_DIR iconengines
    ${ARGN})
endmacro()

macro(stkMacroBuildQtStylesPlugin)
  stkMacroBuildQtPlugin(
    PLUGIN_DIR styles
    ${ARGN})
endmacro()
