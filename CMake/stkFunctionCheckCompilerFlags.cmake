...
#
# Usage:
#   stkFunctionCheckCompilerFlags(FLAGS_TO_CHECK VALID_FLAGS_VAR)
#
# Example:
#
#   set(myflags)
#   stkFunctionCheckCompilerFlags("-fprofile-arcs" myflags)
#   message(1-myflags:${myflags})
#   stkFunctionCheckCompilerFlags("-fauto-bugfix" myflags)
#   message(2-myflags:${myflags})
#   stkFunctionCheckCompilerFlags("-Wall" myflags)
#   message(1-myflags:${myflags})
#
#   The output will be:
...
function(stkFunctionCheckCompilerFlags CXX_FLAG_TO_TEST RESULT_VAR)
  ...
  # For that same reason, stkFunctionCheckCompilerFlags function appends a unique suffix to 
