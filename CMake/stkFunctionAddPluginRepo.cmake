...
function(stkFunctionAddPluginRepo)

  stkMacroParseArguments("" "NAME;GIT_URL;GIT_TAG;GIT_PROTOCOL" "" ${ARGN})
  ...
  foreach(_plugin_path ${_plugin_paths})
    ...
    stk_plugin_option(${_plugin_name} "Build the ${_plugin_name} plugin." OFF)

    # Push the value which might have been changed in stk_plugin_option to the parent scope
    set(STK_PLUGIN_${_plugin_name} ${STK_PLUGIN_${_plugin_name}} PARENT_SCOPE)

    set(${_plugin_name}_SOURCE_DIR ${${_NAME}_DIR}/${_plugin_name})
    set(${_plugin_name}_SOURCE_DIR ${${_plugin_name}_SOURCE_DIR} PARENT_SCOPE)

    if(STK_PLUGIN_${_plugin_name} AND NOT EXISTS ${${_plugin_name}_SOURCE_DIR})
      execute_process(
  ...
  set(STK_PLUGINS ${STK_PLUGINS} PARENT_SCOPE)
