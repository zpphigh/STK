...
#! stkFunctionExtractPluginTargets("${build_options}" ALL target_names)
...
#!
function(stkFunctionExtractPluginTargets my_opts my_filter var_targets)
  ...
  set(plugin_targets )
  foreach(opt ${my_opts})
    stkFunctionExtractOptionNameAndValue(${opt} plugin_name_with_dirs plugin_value)
