...
function(stkFunctionGetTargetDependencies var_deps)

  stkMacroParseArguments(MY "TARGETS" "ALL" ${ARGN})
  ...
  foreach(_target ${MY_TARGETS})
    ...
    # a previous invocation of the stkMacroValidateBuildOptions macro.
  ...
  if (_targets)
    ...
    if(NOT MY_ALL)
      ...
      stkMacroGetAllProjectTargetLibraries("${_targets}" _targets)
    endif()
  endif()
