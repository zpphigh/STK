...
#!
#! \ingroup CMakeAPI
function(stkFunctionGenerateDGraphInput dir target_directories)
  if(NOT EXISTS ${dir})
  ...
  foreach(target_info ${target_directories})
    ...
    if(${include_dep})
      ...
      if(MY_WITH_EXTERNALS)
        set(stk_dependencies ${dependencies})
      else()
        # filter dependencies starting with STK org org_commontk_
