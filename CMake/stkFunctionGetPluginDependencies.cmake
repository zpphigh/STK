...
function(stkFunctionGetPluginDependencies var_deps)

  stkMacroParseArguments(MY "PLUGINS" "ALL" ${ARGN})
  ...
  if(MY_ALL)
    stkFunctionGetTargetDependencies(_targets TARGETS ${MY_PLUGINS} ALL)
  else()
    stkFunctionGetTargetDependencies(_targets TARGETS ${MY_PLUGINS})
  endif()
