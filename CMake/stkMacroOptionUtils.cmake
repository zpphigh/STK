...
function(stk_option_logical_expression_to_message varname logical_expr)
  set(enabling_msg)
...
macro(stk_option option_prefix name doc default)
  ...
  if(_logical_expr AND NOT ${option_prefix}_${name})
    if(${ARGN})
      ...
      # logical expression should contain a STK_ENABLE_*
      ...
      set(enabling_msg)
      stk_option_logical_expression_to_message(enabling_msg "${ARGN}")
      message(STATUS "Enabling [${option_prefix}_${name}] because of [${enabling_msg}] evaluates to True")
    endif()
  endif()
endmacro()

macro(stk_lib_option name doc default)
  stk_option(STK_LIB ${name} ${doc} ${default} ${ARGN})
  if(STK_BUILD_ALL_LIBRARIES)
    set(STK_LIB_${name} 1)
  endif()
endmacro()

macro(stk_plugin_option name doc default)
  stk_option(STK_PLUGIN ${name} ${doc} ${default} ${ARGN})
  if(STK_BUILD_ALL_PLUGINS)
    set(STK_PLUGIN_${name} 1)
  endif()
endmacro()

macro(stk_app_option name doc default)
  stk_option(STK_APP ${name} ${doc} ${default} ${ARGN})
  if(STK_BUILD_ALL_APPS)
    set(STK_APP_${name} 1)
  endif()
endmacro()

macro(stk_enable_option_raw name doc default)
...
macro(stk_enable_option name doc default)
  stk_enable_option_raw(STK_ENABLE_${name} ${doc} ${default} ${ARGN})
endmacro()
