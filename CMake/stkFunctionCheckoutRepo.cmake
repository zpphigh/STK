...
function(stkFunctionCheckoutRepo)

  stkMacroParseArguments("" "NAME;GIT_URL;GIT_TAG;GIT_PROTOCOL;CHECKOUT_DIR" "" ${ARGN})
  ...
  configure_file(${STK_CMAKE_DIR}/stkCheckoutRepo.cmake.in
