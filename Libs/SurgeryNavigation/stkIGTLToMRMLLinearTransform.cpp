...
#include "stkIGTLToMRMLLinearTransform.h"
...
//---------------------------------------------------------------------------
vtkStandardNewMacro(stkIGTLToMRMLLinearTransform);
vtkCxxRevisionMacro(stkIGTLToMRMLLinearTransform, "$Revision: 15552 $");


//---------------------------------------------------------------------------
stkIGTLToMRMLLinearTransform::stkIGTLToMRMLLinearTransform()
{
}
...
//---------------------------------------------------------------------------
void stkIGTLToMRMLLinearTransform::PrintSelf(ostream& os, vtkIndent indent)
{
  this->vtkObject::PrintSelf(os, indent);
}

//---------------------------------------------------------------------------
vtkMRMLNode* stkIGTLToMRMLLinearTransform::CreateNewNode(vtkMRMLScene* scene, const char* name)
{
...
//---------------------------------------------------------------------------
vtkIntArray* stkIGTLToMRMLLinearTransform::GetNodeEvents()
{
  vtkIntArray* events;
...
//---------------------------------------------------------------------------
int stkIGTLToMRMLLinearTransform::IGTLToMRML(igtl::MessageBase::Pointer buffer, vtkMRMLNode* node)
{
...
//---------------------------------------------------------------------------
int stkIGTLToMRMLLinearTransform::MRMLToIGTL(unsigned long event, vtkMRMLNode* mrmlNode, int* size, void** igtlMsg)
{
...
//---------------------------------------------------------------------------
void stkIGTLToMRMLLinearTransform::SetVisibility(int sw, vtkMRMLScene * scene, vtkMRMLNode * node)
{
...
//---------------------------------------------------------------------------
vtkMRMLModelNode* stkIGTLToMRMLLinearTransform::AddLocatorModel(vtkMRMLScene * scene, const char* nodeName, double r, double g, double b)
{
